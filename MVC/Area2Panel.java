...
public class Area2Panel extends JPanel {
    ...
    private final int gridSize = 3; // Size of the grid (3x3)
    private JPanel areaTilesPanel; // Reference to the area tiles panel

    public Area2Panel(JPanel cards) {
    ...
    private void showBattlePhasePanel() {
        BattlePhasePanel2 battlePhasePanel2 = new BattlePhasePanel2(chosenStarterCreature, area2);
